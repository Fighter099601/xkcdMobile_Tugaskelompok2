...
public class ComicDownloader {
    ...
    public boolean isFilePresent(String dirName, String pathRelativeToRoot) {
        String totalPath = Environment.getExternalStorageDirectory().toString() + dirName + pathRelativeToRoot;
